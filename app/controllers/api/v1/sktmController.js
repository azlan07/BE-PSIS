...
module.exports = {
  async handleCreateSktm(req, res, linkKtp, linkKk, linkRmhDpn, linkRmhSpg, linkRmhBlk) {
    try {
      req.body.imageKtp = linkKtp
      req.body.imageKk = linkKk
      req.body.imageRmhDpn = linkRmhDpn
      req.body.imageRmhSpg = linkRmhSpg
      req.body.imageRmhBlk = linkRmhBlk
      const body = req.body;
